...
<link rel="stylesheet" type="text/css" href="${initParam.staticPath}/css/base.css" media="all" />
<link rel="stylesheet" type="text/css" href="${initParam.staticPath}/css/psearch20131008.css" media="all" />
<link rel="stylesheet" type="text/css" href="${initParam.staticPath}/css/psearch.onebox.css" media="all" />
<link rel="stylesheet" type="text/css" href="${initParam.staticPath}/css/pop_compare.css" media="all" />
<script type="text/javascript" src="${initParam.staticPath}/js/jquery-1.2.6.min.js"></script>
</head>
<body>
<script type="text/javascript" src="${initParam.staticPath}/js/base-2011.js" charset="utf-8"></script>
<!-- header start -->
...
<!-- footer end -->
<script type="text/javascript" src="${initParam.staticPath}/js/jquery.hashchange.js"></script>
<script type="text/javascript" src="${initParam.staticPath}/js/search_main.js"></script>
