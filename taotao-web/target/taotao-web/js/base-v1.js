...
function regist() {
    return location.href = "http://sso.taotao.com/user/register.html";
}
...
function search(a) {
    var b = "http://search.taotao.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
