...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="${initParam.staticPath}/css/regist.personal.css"/>
    <link type="text/css" rel="stylesheet" href="${initParam.staticPath}/css/passport.base.css"/>
    <script type="text/javascript" src="${initParam.staticPath}/js/jquery-1.2.6.min.js"></script>
</head>
<body>
...
<div class="w" id="logo">
    <div>
    	<a href="http://www.taotao.com/">
    		<img src="${initParam.staticPath}/images/taotao-logo.gif" alt="淘淘商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    ...
    <div class="mc">
        <form id="personRegForm" method="post" onsubmit="return false;">
            ...
            <div class="phone">
                <img width="180" height="180" src="${initParam.staticPath}/images/phone-bg.jpg">
            </div>
                        <span class="clr"></span>
        </form>
    </div>
...
<script type="text/javascript" src="${initParam.staticPath}/js/register/jd.lib.js"></script>
<script type="text/javascript" src="${initParam.staticPath}/js/register/jdThickBox.js"></script>
<script type="text/javascript" src="${initParam.staticPath}/js/register/jdValidate.js"></script>
<script type="text/javascript" src="${initParam.staticPath}/js/register/jdValidate.emReg.js"></script>
<script type="text/javascript" src="${initParam.staticPath}/js/register/jdValidate.regSuccess.js"></script>
